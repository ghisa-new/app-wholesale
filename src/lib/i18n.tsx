...
const translations = {
  tr: {
    ...
    perItemPrice: "adet fiyatı",
    taxExcluded: "Fiyatlara KDV dahil değildir",
    lotPriceLabel: "1 Seri Fiyatı",
    lotQuantity: "Seri adedi",
    sortBy: "Sirala",
    searchProducts: "Ara: ürün adı veya model kodu…",
  ...
  en: {
    ...
    taxExcluded: "Prices exclude VAT",
    lotPriceLabel: "Price per Lot",
    lotQuantity: "Lot quantity",
    sortBy: "Sort by",
    searchProducts: "Search: product name or model code…",
  ...
  ar: {
    ...
    perItemPrice: "سعر القطعة",
    taxExcluded: "الأسعار لا تشمل ضريبة القيمة المضافة",
    lotPriceLabel: "سعر السيري الواحد",
    lotQuantity: "عدد المجموعات",
    sortBy: "ترتيب حسب",
    searchProducts: "ابحث: اسم المنتج أو رمز الموديل…",
